...
Func OpenBlueStacks($bRestart = False)
	...
	$PID = ShellExecute($BSPath & "HD-RunApp.exe", "-p com.supercell.clashofclans.kunlun -a com.supercell.clashofclans.GameAppKunlun")  ;Start BS and CoC with command line
