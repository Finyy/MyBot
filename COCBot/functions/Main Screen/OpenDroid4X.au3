...
Func OpenDroid4X($bRestart = False)
   ...
   ;WEnd
    ...
    LaunchConsole($__Droid4X_Path & "adb.exe", "-s " & $AndroidAdbDevice & " shell am start -S -n com.supercell.clashofclans/.GameAppKunlun", $process_killed, 30 * 1000) ; removed "-W" option and added timeout (didn't exit sometimes)
